...
ActiveRecord::Schema.define(version: 20170926052935) do
  ...
  create_table "dishes_menus", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "mailings", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "restaurant_id"
    t.integer  "user_id"
    t.string   "mail"
    t.datetime "created_at",    null: false
  ...
  create_table "payements", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_id"
